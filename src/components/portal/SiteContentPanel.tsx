...
// Homepage marketing copy, edited by an admin. Lives as a panel rather than its
// own page so it sits in the Settings tab strip with the other site-wide
// controls, instead of being a separate sidebar entry.
