...
export function RequireRole({
  ...
  // keeps the whole staff back-end off the marketing domain. A portal URL there
  // must behave as if no portal exists: send it to the public home page rather
  // than redirecting to the app host, which would disclose that address.
  ...
  if (wrongHost) return <PageLoader label="Loading…" />;
